                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="titre" id="titre"
                            ...
                            placeholder="Enter the title of the job offer" required="">
                    </div>
                    <div class="col-span-2">
                        ...
                        <textarea id="description" rows="4" name="description"
                            ...
                            placeholder="Enter description of the job offer"></textarea>
                    </div>
                    <div class="col-span-2">
                        <label for="required_skills"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Required skills</label>
                        <div class="relative" style="position: relative;">
                            <input type="text" name="required_skills[]" id="required_skills"
                                ...
                                placeholder="Enter the required skills" required="">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="location" id="location"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Enter the location of the job offer" required="">
                    </div>
