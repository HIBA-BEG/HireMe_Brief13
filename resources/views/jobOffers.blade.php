    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="ml-4 p-6 text-gray-900 dark:text-gray-100">
                <h3 class="text-red-500">Vous devez vous <a href="{{route('login')}}" class="underline font-semibold">Connecter</a> ou <a href="{{route('registerChercheur')}}" class="underline font-semibold">Créer un Compte</a> pour postuler à des offres</h3>
            </div>
